...
public class SbElasticSearchJavacodegeeks implements CommandLineRunner {

    @Autowired
    private MovieService movieService;

    private static final Logger logger = LoggerFactory.getLogger(SbElasticSearchJavacodegeeks.class);
...
// to elastic search
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication.run(SbElasticSearchJavacodegeeks.class, args);
    }
}